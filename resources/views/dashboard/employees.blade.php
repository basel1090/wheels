...
<script>
    ...
    var datatable = createDataTable('#datatablewhd', columnDefs, "{{route('employee.listWhour')}}?employee_name=" + $('#employee_name').val() + "&to=" + $('#to').val() + "&from=" + $('#from').val(), [
        [3, "DESC"]
    ]);
</script>
<script>
            ...
            <div class="card-body py-4">
                ...
                <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5" id="datatablewhd">
                    ...
                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Qty (hrs)</th>
