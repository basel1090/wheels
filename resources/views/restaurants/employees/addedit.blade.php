            ...
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_employee_scroll" data-kt-scroll="true"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2" data-input-name="Email">
                                {{ __('Email') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2" data-input-name="Mobile">Title
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($employee) ? $employee->title : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
