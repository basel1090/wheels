<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-employees-table-filter="searchEmployee"
    ...
    @isset($restaurant)
        ...
        <script>
            const filterSearchEmployee = document.querySelector('[data-kt-employees-table-filter="searchEmployee"]');
