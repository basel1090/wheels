        ...
        <div class="row">
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fw-semibold fs-6 mb-2" data-input-name="Name (Arabic)">Name
                        (Arabic)</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2" data-input-name="Name (En)">Name
                        (En)</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" name="daily_orders_out_{{ __('no') }}"
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="sys_satisfaction_rate" class="form-control form-control-solid mb-3 mb-lg-0"
                           placeholder="" value="{{ isset($restaurant) ? $restaurant->sys_satisfaction_rate : '' }}"/>
                    <!--end::Input-->
                </div>
            </div>
            ...
            <div class="col-md-3 d-none d-none">
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" disabled name="total_orders" class="form-control form-control-solid mb-3 mb-lg-0"
            ...
            <div class="col-md-3 d-none">
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" disabled name="total_sales_cash" class="form-control form-control-solid mb-3 mb-lg-0"
            ...
            <div class="col-md-3 d-none">
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number"disabled  name="total_sales_visa" class="form-control form-control-solid mb-3 mb-lg-0"
