<div class="row">
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            <!--begin::Label-->
            <label class="fw-semibold fs-6 mb-2" data-input-name="">  {{__('Marketing Representitive Compnay Name')}}
            </label>
            <!--end::Label-->
            <!--begin::Input-->
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            <!--begin::Label-->
            <label class="fw-semibold fs-6 mb-2" data-input-name="">{{__('Monthly Payment')}}
            </label>
            <!--end::Label-->
            <!--begin::Input-->
